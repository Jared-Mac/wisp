...
Share, camera, and disconnect share the room-control row. The soundboard sits beside mute and deafen, with the compact menu from the soundboard release. The redundant top soundboard button is removed. Stream start/stop cues include your own screen; separate viewer cues indicate arrivals and departures from your stream. Each category can be muted or assigned custom sounds in Notifications.
