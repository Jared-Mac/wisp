...
Rectangle {
  ...
  Row {
    ...
    Flow {
      ...
      ChatButton {
        id: soundboardButton; objectName: "serverSoundboardButton"
        theme: root.theme; text: "Soundboard"; iconName: "soundboard"; iconOnly: true; forceIcon: true
        width: Math.min(controls.width, controls.cell); height: audio.buttonHeight
        Accessible.name: "Open soundboard"
        ToolTip.visible: (hovered || visualFocus) && !menu.visible; ToolTip.text: "Soundboard"
