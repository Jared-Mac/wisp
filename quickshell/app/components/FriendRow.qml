...
Item {
  ...
  WispAvatar { id: avatar; theme: root.theme; name: root.friend.display_name; visible: root.theme.friendly; anchors.left: parent.left; anchors.verticalCenter: parent.verticalCenter }
  PresenceDot {
    id: dot
    objectName: "friendConnectionDot"
    z: 1
    anchors.left: parent.left
    anchors.leftMargin: root.theme.friendly ? root.theme.space(21) : root.theme.spacing.sm
  ...
  ChatButton {
    id: messageButton; theme: root.theme
