...
Column {
  ...
  Rectangle {
    ...
    ScrollView {
      ...
      anchors.leftMargin: root.theme.friendly ? root.theme.space(42) : root.theme.tui ? root.theme.space(24) : root.theme.spacing.lg
    ...
    ChatButton {
      ...
      contentItem: Item {
        ...
        Canvas {
          ...
          visible: !root.busy && !root.theme.tui && !root.theme.friendly
