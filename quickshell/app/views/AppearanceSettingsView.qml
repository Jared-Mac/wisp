...
Column {
  ...
  Flow {
    ...
    Repeater {
      model: [
        {profile:"soft_graphite",label:"Soft Graphite",detail:"Quiet dark · default",base:"#181e25",rail:"#222b34",accent:"#8ec5ee",ink:"#e8ecf3",radius:8},
  ...
  Row {
    ...
    theme: root.theme
      ...
      model:[{label:"Terminal and classic styles…",profile:""},{label:"Clean TUI",profile:"clean_tui"},{label:"Terminal Grid",profile:"terminal"},{label:"Performative",profile:"performative"},{label:"Herdr",profile:"herdr"},{label:"Classic",profile:"legacy"}]
  ...
  SettingsSection {
    ...
    theme: root.theme
      ...
      model:[{key:"soft_graphite",label:"Soft Graphite"},{key:"daylight",label:"Daylight"},{key:"hearth",label:"Hearth"},{key:"wisp",label:"Wisp blue"},{key:"graphite",label:"Graphite"},{key:"violet",label:"Violet"},{key:"ember",label:"Ember"},{key:"ash_olive",label:"Ash & Olive"},{key:"herdr",label:"Solarized Japan"}]
