...
Rectangle {
  ...
  color: theme.friendly ? theme.panel : theme.cleanTui ? theme.background : theme.surface
  ...
  Item {
    ...
    height: root.theme.space(root.theme.friendly ? 44 : 34)
    Row {
      id: leadingActions
    ...
    ChatButton {
      ...
      contentItem: Item {
        Text {
          ...
          color: chatSelector.selectorInk; font.family: root.theme.font.family; font.pixelSize: root.theme.friendly ? root.theme.font.body : root.theme.font.caption; font.weight: root.theme.friendly ? Font.DemiBold : Font.Normal
        }
