...
for fixture_mode in ${WISP_TEST_MODES:-app makeover tuirefinement responsive memory image panel settings privacy panelprivacy edit interactions panelinteractions files clearroom cleardm roomsettings newroom themes friends identity panelidentity identityactions panelidentityactions workspace saved traycollapse presence panelpresence picker tilemoves tiles tilesreload newchat addchat multiserver channeltiles panelchanneltiles shortcuts audiotooltips panelaudiotooltips latest panellatest imagegeometry panelimagegeometry roomcleanup cleantui returnchat invites panelinvites serversettings panelserversettings}; do
  screenshot=""
